##CSD325-T301 Advanced Python (2265-1)
...
while True:  # Main game loop.
    ...
    ##INSERT NEW BONUS
    # Determine bonus eligibility and add to player mon.
    #rollTot variable initilization
    rollTot = (dice1 + dice2)

    print('The total of the roll is', rollTot, '.')

    if rollTot in (2 , 7):
        print('You win a bonus of 10 mon.')
        purse = purse + 10
    else:
